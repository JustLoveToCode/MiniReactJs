...
export default function App(){
  ...
  // Shared State: Lifting the State Upward for Shared Component:
...
function Friend({friend, onSelection, selectedFriend}){
  // Check whether the Boolean is true or false for isSelected
...
return(
  ...
  {friend.balance >0 && <p className='green'> owe you {friend.name} {Math.abs(friend.balance)} € </p>}
...
function FormSplitBill({selectedFriend, onSplitBill}){
  ...
  return <form className='form-split-bill' onSubmit={handleSubmit}>
    ...
    <input type="text" value={paidByUser} onChange={(e)=>setPaidByUser(Number(e.target.value)> bill ? 
