...
function MovieDetails({selectedId, onCloseMovie, onAddWatched, watched}){
  ...
  // Object Destructuring for the properties for the data above
  ...
  // Adding the New Object with the following properties:
  function handleAdd(){
  ...
  useEffect(function(){
    ...
    // Invoke the async function getMovieDetails:
    getMovieDetails();
    // Using the Dependency Array [selectedId]
  }, [selectedId])
